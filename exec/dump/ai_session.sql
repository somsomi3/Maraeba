...
CREATE TABLE `ai_session` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKcuextd789ken70lk81k4cueh6` (`user_id`),
  CONSTRAINT `FKcuextd789ken70lk81k4cueh6` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
...
-- Dump completed on 2025-02-24 21:06:09
